...
export const svgDefaultProps = {
  ...
  nodeInnerPadding: 0,
  nodeBorderWidth: 1,
  nodeBorderColor: { from: 'color', modifiers: [['darker', 0.5]] } as InheritedColorConfig<SankeyNodeDatum<any, any>>,
  nodeBorderRadius: 0,
  ...
  labelTextColor: { from: 'color', modifiers: [['darker', 0.8]] } as InheritedColorConfig<SankeyNodeDatum<any, any>>,
